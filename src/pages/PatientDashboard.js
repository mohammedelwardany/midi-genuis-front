      ...
      <div className="animate-in fade-in duration-500 max-w-6xl mx-auto flex flex-col lg:flex-row gap-8">
         ...
         <div className="flex-1 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
               ...
               <div className="md:col-span-2 bg-primary-700 rounded-[24px] p-8 text-white relative overflow-hidden shadow-lg shadow-primary-700/20 flex flex-col justify-between">
                  {/* Decorative elements */}
                  ...
                  <table className="w-full text-start border-collapse min-w-[600px]">
                     <thead>
                        <tr className="border-b border-slate-100 text-[10px] font-bold text-slate-400 uppercase tracking-widest bg-slate-50/50">
                           <th className="py-4 px-4 ps-6 rounded-s-lg">{t('patientDashboard.thReportName')}</th>
                           <th className="py-4 px-4">{t('patientDashboard.thDate')}</th>
                           <th className="py-4 px-4">{t('patientDashboard.thDept')}</th>
                           <th className="py-4 px-4">{t('patientDashboard.thStatus')}</th>

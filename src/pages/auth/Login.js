...
export default function Login() {
  ...
  const handleLogin = (e) => {
    ...
    if (email === 'admin' && password === 'admin') {
      ...
      setError('Invalid credentials. Use admin/admin, doctor/doctor, or patient/patient.');
    }
  };
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
               ...
               <a href="#" className="text-[11px] font-bold text-primary-600 hover:text-primary-800 transition-colors">{t('auth.forgotPassword')}</a>
            </div>
            <div className="relative">
          ...
          <button type="submit" className="w-full bg-primary-600 hover:bg-primary-700 hover:-translate-y-0.5 text-white font-bold text-[15px] py-4 rounded-xl shadow-md shadow-primary-600/20 transition-all flex justify-center items-center gap-2 group">
